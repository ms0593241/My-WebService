...
function doGetData() {
	...
	// var requsetTRAUrl =
	// xmlData.getElementsByTagName("TRA-url")[0].firstChild.nodeValue;
	var json2;
	$.ajax({
		type : 'GET',
...
function GetAuthorizationHeader() {
	...
	var Authorization = 'hmac username=\"' + AppID
	...
	return {
		...
		'X-Date' : GMTString
	/* ,'Accept-Encoding': 'gzip' */}; // 如果要將js運行在伺服器，可額外加入 'Accept-Encoding':
										// 'gzip'，要求壓縮以減少網路傳輸資料量
}
